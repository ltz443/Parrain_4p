...
const OFFRES = [
  {
    ...
    bonusParrain: "80€",
    description:
      "Ouvre un compte Hello One et reçois 40€ sans dépôt, puis 40€ supplémentaires dès le 10e achat carte.",
    conditions: [
    ...
    contact: "@parrain_4p",
    note:
      "Pour recevoir ton invitation, envoie ton prénom + adresse email sur Instagram.",
  },
  {
    id: "joko",
    nom: "Joko",
    ...
    description:
      "Joko transforme tes achats quotidiens en micro-économies automatiques en connectant ton compte bancaire.",
    conditions: [
  ...
  if (selected) {
    ...
    return (
      <div style={{ maxWidth: 480, margin: "0 auto", padding: 16 }}>
        <button onClick={() => setSelected(null)} style={{ marginBottom: 20 }}>
          ← Retour
        </button>

        <h2 style={{ fontSize: 24 }}>{o.nom}</h2>
        <p>{o.description}</p>
