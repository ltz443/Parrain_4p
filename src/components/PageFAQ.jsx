...
function FlipCard({ num, question, answer }) {
  ...
  return (
    <div
      ...
      style={{ height: 150, perspective: '1000px', cursor: 'pointer' }}
    >
      <div style={{
        position: 'relative',
        width: '100%',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
            ...
            <div style={{ fontSize: 11, color: '#4A5568' }}>Retaper pour fermer</div>
          </div>
          <div style={{ fontSize: 13, color: '#9AA3B0', lineHeight: 1.65, overflow: 'hidden' }}>{answer}</div>
        </div>
      </div>
    </div>
  );
