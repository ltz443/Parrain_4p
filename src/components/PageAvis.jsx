...
const SEED = [
  { id: "82a51d31-f88a-4cd0-ad03-e9924b4ccd23", nom: "Nathalie", note: 4, texte: "Bonjour bonus hellobank bien recus", created_at: "2026-05-09T13:20:00.314195" },
  { id: "b0b145d2-f596-4105-8bde-4f0adf974d97", nom: "Mathieu", note: 5, texte: "Scrambly 10 minutes c’est plier", created_at: "2026-05-08T21:02:11.414298" },
  { id: "c167af5a-cff9-4c4c-89d7-e357f6090596", nom: "Naofel", note: 5, texte: "Explication claire et précise", created_at: "2026-05-08T01:48:29.766176" },
  { id: "c738ffd3-0da5-4443-acd4-7b08d5a4a0fe", nom: "Jvle", note: 5, texte: "10€ bonus recus avec hellobank veracash myfin +110", created_at: "2026-05-08T01:32:29.082748" },
  { id: "d27ef9db-d431-4168-b3b0-14d80690c162", nom: "Noa", note: 5, texte: "Merci pour myfin", created_at: "2026-05-02T11:43:06.885476" },
  { id: "548d3e58-f8b4-44ea-aab5-2f6564a0cd0f", nom: "Many", note: 5, texte: "Bourso 👌", created_at: "2026-05-02T11:25:51.656685" },
  { id: "280a3d39-a486-4b4d-b885-5cc6f6d78bf3", nom: "Leo", note: 5, texte: "Boursorama valider", created_at: "2026-05-01T22:43:34.103534" },
  { id: "228890fe-61af-4522-af69-6acb64a3b464", nom: "Diego", note: 5, texte: "Prime hellobank reçus se matin", created_at: "2026-04-29T00:17:16.722697" },
  { id: "da6e08fc-cf38-4d24-8b93-717d6847db1e", nom: "Laetitia", note: 5, texte: "5/5 joko", created_at: "2026-04-27T22:51:54.42524" },
  { id: "1d2805d6-28f9-4110-bd75-ea8f5358b228", nom: "Mathis", note: 5, texte: "Rapide efficace merci chef ( winnamax )", created_at: "2026-04-26T22:14:56.33427" },
  { id: "edb9cb52-bffa-437f-b635-488c89180364", nom: "Thomas", note: 5, texte: "Site très simple à comprendre avec des offres vérifiées qui fonctionnent vraiment !\nJe recommande fortement si vous voulez faire de l’argent rapidement", created_at: "2026-04-26T22:13:45.543419" },
  { id: "def4e26c-8d7f-44ce-b173-14b15e9ed08f", nom: "Kerry", note: 5, texte: "Franchement très bon cite n’hésitez pas🔥", created_at: "2026-04-26T21:22:23.065196" },
  { id: "896a85ef-6131-4b4b-8650-99106c1acf48", nom: "Koro", note: 5, texte: "Trading 212 40€ en 10 minutes merci bg", created_at: "2026-04-24T20:34:29.114262" },
  { id: "a4566482-d264-40cc-a0ed-36804b771872", nom: "Lolo", note: 5, texte: "50 sur trading 212 merci beaucoup ^", created_at: "2026-04-18T18:12:38.041598" },
];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (Array.isArray(result) && result[0]) {
        setAllReviews([result[0], ...allReviews]);
      } else {
        const newReview = { id: Date.now(), nom: name.trim(), note: rating, texte: text.trim(), created_at: new Date().toISOString() };
